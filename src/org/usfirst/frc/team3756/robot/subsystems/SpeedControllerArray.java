 ...
 * DESCRIPTION: This class will run code that attaches multiple speed controllers together to act as one speed controller. This class allows the
 * 				possibility of bypassing the RobotDrive class's 4 speed controller limit. Credit to pblankenbaker from team #0868 for the code. 
 */
